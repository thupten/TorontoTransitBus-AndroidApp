...
public class StopsAdapter extends SimpleCursorAdapter implements SpinnerAdapter {
	private Context context = null;
	private String[] data = null;

	public StopsAdapter(Context context, int layout, Cursor cursor, String[] from, int[] to, int flags) {
